            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="container py-5">
                        <h1>¿Deseas eliminar la peliculas <strong> {{ $titulo }} {{ $id }} ? </strong></h1>
                    ...
                    <form method="post" action="{{ route('peliculas.destroy',[ 'id'=>$id ])}}">
                        ...
                        <a class="text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" href="{{-- {{ route('peliculas.cancelar') }} --}}">
